...
def home(request):
    return render(request, '/Templates/ArquivosHTML/home.html')
def about(request):
    return render(request, '/Templates/ArquivosHTML/about.html')
def search(request):
    tabelas = Tabela_Disponibilidade.objects.all().order_by('nome_ubs', 'nome_vacina')
    return render(request, '/Templates/ArquivosHTML/search.html', {'tabelas': tabelas})
...
def more_info(request):
    ...
    return render(request, '/Templates/ArquivosHTML/more_info.html', {'tabelas': tabelas})
