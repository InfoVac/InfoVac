...
def home(request):
    return render(request, '/opt/render/project/src/TabelaDeVacinas/Templates/home.html')
def about(request):
    return render(request, '/opt/render/project/src/TabelaDeVacinas/Templates/about.html')
def search(request):
    tabelas = Tabela_Disponibilidade.objects.all().order_by('nome_ubs', 'nome_vacina')
    return render(request, '/opt/render/project/src/TabelaDeVacinas/Templates/search.html', {'tabelas': tabelas})
...
def more_info(request):
    ...
    return render(request, '/opt/render/project/src/TabelaDeVacinas/Templates/more_info.html', {'tabelas': tabelas})
